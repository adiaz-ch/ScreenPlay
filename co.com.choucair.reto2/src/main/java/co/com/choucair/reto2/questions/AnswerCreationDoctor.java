...
import co.com.choucair.reto2.userinterface.ConfirmationPage;
...
public class AnswerCreationDoctor implements Question<Boolean> {
    ...
    public Boolean answeredBy(Actor actor) {
        boolean result;
        String title = Text.of(ConfirmationPage.CONFIRMATION_MESSAGE).viewedBy(actor).asString().replace(".", "").trim();
